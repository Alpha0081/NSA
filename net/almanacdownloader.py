...
class AlmanacDownloader:
    def __init__(self, root_path: str, satellite_system_name: str, url: str):
        if not self.check_almanac_file(root_path, satellite_system_name.lower()):
            self.download_almanac(root_path, url, satellite_system_name.lower())

    def download_almanac(self, root_path: str, url: str, file_name: str, file_type: str = ".json"):
